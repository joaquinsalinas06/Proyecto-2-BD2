"""
Benchmark 01: Airbnb Isam File Index + R-Tree
...
def run_benchmark():
    print("BENCHMARK 01: AIRBNB - Isam FILE INDEX + R-TREE")
    ...
    for csv_path, size_label in datasets:
        ...
        try:
            ...
            start = time.time()
            create_sql = f"CREATE TABLE {table_name} FROM FILE '{temp_bulk_csv}' USING PRIMARY INDEX ISAM(id), INDEX RTREE(location);"
            print(f"   📝 {create_sql}")
            tm.sql(create_sql)
    ...
    print("\n" + "="*140)
    print("RESUMEN DE ESTADÍSTICAS DE I/O - Isam FILE + R-TREE INDEX")
    print("="*140)
    ...
    print("   Isam (id):    Búsqueda exacta y rangos")
